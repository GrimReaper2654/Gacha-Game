...
const weapons = [
    ...
    {
        name: `Mythril Rapier`,
        displayName: `Mythril Rapier`,
        description: `A lightweight and thin blade forged from enchanted mythril. Designed for swift light attacks.`,
        rarity: SR,
        pfp: `assets/sword11.png`,
        useable: false,
        equipable: true,
        effects: {
            slot: hand,
            atk: {physical: [15, 10, 100], magic: [0, 5, -1]},
            def: {physical: [10, 5], magic: [0, 5]},
            stat: {
                str: 0,
                int: 0,
                hp: [0, 0],
    ...
    {
        name: `Advanced Staff`,
        displayName: `Advanced Staff`,
        description: `A powerful magic staff.`,
        rarity: SR,
        pfp: `assets/staff2.png`,
        useable: false,
        equipable: true,
        effects: {
            slot: hand,
            atk: {physical: [1, 0, 50], magic: [10, 15, 500]},
            def: {physical: [1, 0], magic: [5, 0]},
            stat: {
                str: 0,
                int: 0,
                hp: [0, 0],
...
const armours = [
    {
        ...
        rarity: N,
        pfp: `assets/armour4.png`,
        useable: false,
        equipable: true,
        effects: {
            slot: body,
            atk: {physical: [0, 0, -1], magic: [0, 0, -1]},
            def: {physical: [2, 5], magic: [2, 0]},
            stat: {
                str: 0,
                int: 0,
                hp: [0, 0],
    ...
    },
    {
        ...
        description: `A lightweight set of leather and iron armour. Provides decent protection but slightly restricts movement.`,
        rarity: N,
        pfp: `assets/armour3.png`,
        useable: false,
        equipable: true,
        effects: {
            slot: body,
    ...
    },
    {
        ...
        displayName: `Celestial Armour`,
        description: `This legendary armor is forged from a rare celestial metal that shimmers with an ethereal glow. It offers unmatched protection from both physical and magical threats, making it ideal for elite warriors and defenders of the realm.`,
        rarity: E,
        pfp: `assets/armour5.png`,
        useable: false,
        equipable: true,
        effects: {
            slot: body,
            atk: {physical: [0, 0, -1], magic: [0, 0, -1]},
            def: {physical: [40, 30], magic: [30, 30]},
            stat: {
                str: -0,
                int: 0,
                hp: [0, 0],
