...
const gachaGameDrops = {
    ...
    enemy: {
        ...
        goblinGuard: [{type: exp, quantity: 500, chance: 100}, {type: gold, quantity: 50, chance: 100}, {type: item, quantity: 1, chance: 75, item: 'stone1'}],
        goblinBoss: [{type: exp, quantity: 2500, chance: 100}, {type: gold, quantity: 250, chance: 100}, {type: item, quantity: 1, chance: 100, item: 'stone2'}],

        dragonGreen: [{type: exp, quantity: 2500, chance: 100}, {type: gold, quantity: 300, chance: 100}, {type: item, quantity: 1, chance: 25, item: 'stone4'}],
        dragonRainbow: [{type: exp, quantity: 7500, chance: 100}, {type: gold, quantity: 500, chance: 100}, {type: item, quantity: 1, chance: 50, item: 'stone4'}],
        dragonBlue: [{type: exp, quantity: 15000, chance: 100}, {type: gold, quantity: 900, chance: 100}, {type: item, quantity: 1, chance: 90, item: 'stone4'}],
        dragonRed: [{type: exp, quantity: 25000, chance: 100}, {type: gold, quantity: 2000, chance: 100}, {type: item, quantity: 1, chance: 75, item: 'stone4'}],
        dragonBlack: [{type: exp, quantity: 75000, chance: 100}, {type: gold, quantity: 3000, chance: 100}, {type: item, quantity: 1, chance: 50, item: 'stone5'}],
        dragonRedBig: [{type: exp, quantity: 75000, chance: 100}, {type: gold, quantity: 3000, chance: 100}, {type: item, quantity: 1, chance: 50, item: 'stone5'}],
        ...
        scorpion: [{type: exp, quantity: 1000, chance: 100}, {type: gold, quantity: 90, chance: 100}, {type: item, quantity: 1, chance: 40, item: 'stone2'}],
        snake: [{type: exp, quantity: 1000, chance: 100}, {type: gold, quantity: 90, chance: 100}, {type: item, quantity: 1, chance: 60, item: 'stone2'}],

        chickenWeaker: [{type: exp, quantity: 10000, chance: 100}, {type: item, quantity: 1, chance: 10, item: 'stone5'}],
        chicken: [{type: exp, quantity: 25000, chance: 100}, {type: item, quantity: 1, chance: 25, item: 'stone5'}],
        chickenStrong: [{type: exp, quantity: 100000, chance: 100}, {type: item, quantity: 1, chance: 50, item: 'stone5'}],
        chickenStronger: [{type: exp, quantity: 250000, chance: 100}, {type: item, quantity: 1, chance: 75, item: 'stone5'}],
        chickenVeryStrong: [{type: exp, quantity: 750000, chance: 100}, {type: item, quantity: 1, chance: 100, item: 'stone5'}],
