...
const debuffEffects = { // effects (debuffs)
    ...
    pervertedStare: {
        ...
        stats: [
            ...
            {
                icon: `shield.png`,
                desc: `- 200 physical negation`,
            },
            {
                icon: `blueShield.png`,
                desc: `- 200 magical negation`,
            },
        ],
        // inflict damage per round
        type: physical, 
...
const intermediateSwordAttacks = { // sword attacks but better
    dagger: {
        name: `Stab`,
        desc: `[attacker] stabs the targeted enemy's weak point with [pronoun] combat knife.`,
        animation: { 
            range: melee,
            projectile: 'swordThrust',
            hitEffect: 'none',
...
const healingSkills = { // heals
    ...
    improvedFirstAid: {
        name: `First Aid`,
        desc: `[attacker] uses a first aid kit to recover some health or heal an ally.`,
        animation: { 
            range: ranged,
            projectile: 'healingLight',
            hitEffect: 'hpUp',
...
const selfBuffs = { // self enhancement
    ...
    evasiveManoeuvers: { // TODO: lower hitchance somehow instead of making character immortal
        name: `Evasive Manoeuvers`,
        desc: `[attacker] dodges most attacks in the next round.`,
        animation: { 
            range: ranged,
            projectile: 'none',
            hitEffect: 'defUp',
...
const debuffSkills = { // makes target weak
    ...
    poisonPowder: {
        name: `Poison Powder`,
        desc: `[attacker] poisons the targeted enemy, weakening them.`,
        animation: { 
            range: 'ranged',
            projectile: 'bagOfWhitePowder',
            hitEffect: 'poisonUp',
...
const magicAttacks = { // spells
    ...
    infernoBeam: {
        name: `Inferno Beam`, 
        desc: `[attacker] launches a concentrated jet of fire and plasma at the targeted enemy.`, 
        animation: { 
            range: ranged,
            projectile: 'fireBlast',
            hitEffect: 'none',
    ...
    gigaInferno: {
        name: `Giga Inferno`, 
        desc: `[attacker] fires a davastating blast of superheated plasma at the targeted enemy.`, 
        animation: { 
            range: ranged,
            projectile: 'fireBlast',
            hitEffect: 'none',
    ...
    energybeam: {
        name: `Energy Beam`, 
        desc: `[attacker] fires a concentrated beam of pure energy at the targeted enemy.`, 
        animation: { 
            range: ranged,
            projectile: 'railDart',
            hitEffect: 'none',
    ...
    energyBlast: {
        name: `Energy Blast`, 
        desc: `[attacker] fires a concentrated beam of energy at the targeted enemy.`, 
        animation: { 
            range: ranged,
            projectile: 'railDart',
            hitEffect: 'none',
    ...
    godray: {
        name: `Godray`, 
        desc: `[attacker] fires a devastating beam of energy at the targeted enemy.`, 
        animation: { 
            range: ranged,
            projectile: 'railDart',
            hitEffect: 'none',
...
const modernWeaponry = { // guns and bombs
    ...
    sniperRifle: {
        name: `Snipe`,
        desc: `[attacker] headshots the targeted enemy with a sniper rifle.`,
        animation: { 
            range: ranged,
            projectile: 'bullet',
            hitEffect: 'none',
    ...
    grenade: {
        name: `grenade`,
        desc: `[attacker] throws a grenade towards the enemies.`,
        animation: { 
            range: fullScreen,
            projectile: 'fireStorm',
            hitEffect: 'none',
    ...
    selfGrenade: {
        name: `explode`,
        desc: `[attacker] explodes themself with a grenade.`,
        animation: { 
            range: fullScreen,
            projectile: 'fireStorm',
            hitEffect: 'none',
    ...
    smallLaserBarrage: {
        name: `Laser Bartage`, 
        desc: `[attacker] fires multiple lasers at the enemies.`, 
        animation: { 
            range: ranged,
            projectile: 'railDart',
            hitEffect: 'none',
...
const uniqueSkills = { // very unbalanced skills
    debugFist: {
        name: `Debug Fist`, 
    ...
    pervertedStare: {
        ...
        desc: `[attacker] stares at the target in a perverted way.`, 
        animation: { 
            range: ranged,
            projectile: 'none',
            hitEffect: 'defDown',
        ...
        dmg: 0, 
        multiplier: none, 
        effects: [{effect: 'pervertedStare', chance: 100}], 
        cost: {hp: 0, mp: 10}, 
        accuracy: 1000, 
        attacks: 1,
    },
    ...
    instantRecovery: {
        ...
        desc: `[attacker] makes a miraculour recovery and attacks the targeted enemy. It's not gojover!`,
        animation: { 
            range: melee,
            projectile: 'swordSwing',
            hitEffect: 'none',
        ...
        multiplier: str,
        effects: [],
        cost: {hp: -10000, mp: 400},
        accuracy: 100,
        attacks: 7,
    },
    recovery: {
        name: `Recovery`,
        desc: `Because every boss needs to regen.`,
        animation: {
            range: ranged,
            projectile: 'none',
            hitEffect: 'hpUp',
